...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cabag_langlink/typo3_versions/'.CabagLanglink_TYPO3_version.'/class.ux_browse_links.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cabag_langlink/typo3_versions/'.CabagLanglink_TYPO3_version.'/class.ux_browse_links.php']);
}
?>
