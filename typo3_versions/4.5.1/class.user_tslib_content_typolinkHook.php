 ...
 */
class user_tslib_content_typolinkHook {
	...
	function main($linktxt, $conf, $linkHandlerKeyword, $linkHandlerValue, $linkParams, &$pObj) {
		...
		$splittetValue = t3lib_div::trimExplode('/',$linkHandlerValue);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cabag_langlink/'.CabagLanglink_TYPO3_version.'/class.user_tslib_content_typolinkHook.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cabag_langlink/'.CabagLanglink_TYPO3_version.'/class.user_tslib_content_typolinkHook.php']);
}
